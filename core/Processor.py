...
from core.ProcEvent import ProcRunEvent, ProcIdleEvent, \
...
class Processor(Process):
    ...
    <core.Scheduler.Scheduler.on_activate>`, :meth:`on_terminated
    <core.Scheduler.Scheduler.on_terminated>` or in a :class:`timer
    <core.Timer.Timer>` handler.
    """
    _identifier = 0
