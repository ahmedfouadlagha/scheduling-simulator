...
import os.path
from core.Task import TaskInfo, task_types
from core.Processor import ProcInfo
from core.Caches import CacheLRU
    ...
    def _parse_caches(self):
        ...
        for cache in caches:
            ...
            if attr['policy'].value == 'LRU' and attr['type'].value == 'data':
                ...
                cache = CacheLRU(attr['name'].value, int(attr['id'].value),
