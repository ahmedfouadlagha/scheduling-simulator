...
from core.etm import execution_time_models
...
class Model(Simulation):
    ...
    def __init__(self, configuration, callback=None):
        ...
        Args:
            ...
            - `configuration`: The :class:`configuration \
                <configuration.Configuration>` of the simulation.
    ...
    def logs(self):
        """
        All the logs from the :class:`Logger <core.Logger.Logger>`.
        """
    ...
    def cycles_per_ms(self):
        ...
        However, the tasks are defined using milliseconds.
        """
