...
def scheduler(name, **kwargs):
	...
	Decorator used to register a scheduler to be returned by get_declared_schedulers().
	Mandatory arguments : 
		name : the complete name of the scheduler (ex : schedulers.EDF)
	...
	def f(klass):
		...
		# klass._name = name
		# klass._required_fields = required_fields
		# klass._required_task_fields = task_f
		# klass._required_proc_fields = proc_f
