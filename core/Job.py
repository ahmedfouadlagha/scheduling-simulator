...
from core.JobEvent import JobEvent
...
class Job(Process):
    ...
    def __init__(self, task, name, pred, monitor, etm, sim):
        """
        Args:
            - `task`: The parent :class:`task <core.Task.Task>`.
    ...
    def cpu(self):
        """
        The :class:`processor <core.Processor.Processor>` on which the
    ...
    @property
    def task(self):
        """The :class:`task <core.Task.Task>` for this job."""
        return self._task
